                  ...
                  <div className='cart-item-details'>
                    ...
                    <div>
                      <div className='cart-item-price-container'>
                        <p><span className='price cart-price'>${((item.product.price * item.qty) / 100).toFixed(2)}</span></p>
                        <p><span className='price cart-price-per-item'>${(item.product.price / 100).toFixed(2)} x {item.qty} </span></p>
                      </div>
                    </div>
